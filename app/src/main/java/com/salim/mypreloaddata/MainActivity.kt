...
import com.salim.mypreloaddata.databinding.ActivityMainBinding
import com.salim.mypreloaddata.services.DataManagerService
import com.salim.mypreloaddata.services.DataManagerService.Companion.CANCEL_MESSAGE
import com.salim.mypreloaddata.services.DataManagerService.Companion.FAILED_MESSAGE
import com.salim.mypreloaddata.services.DataManagerService.Companion.PREPARATION_MESSAGE
import com.salim.mypreloaddata.services.DataManagerService.Companion.SUCCESS_MESSAGE
import com.salim.mypreloaddata.services.DataManagerService.Companion.UPDATE_MESSAGE
...
class MainActivity : AppCompatActivity(), HandlerCallback {
    ...
    override fun loadSuccess() {
        ...
        startActivity(Intent(this@MainActivity, MahasiwaActivity::class.java))
        finish()
    }
